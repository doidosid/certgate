...
export const certificateRequestPage = page<CertificateRequestItem>([
	...
	},
	{
		...
		deviceId: "0d6515ae-d560-4777-b102-054e71f98ef9",
		status: "APPROVED",
		sanUri: "urn:certgate:device:sensor-floor-02",
		publicKeyAlgorithm: "EC P-256",
	...
	},
	{
		...
		status: "REJECTED",
		sanUri: "urn:certgate:device:sensor-gate-01",
		publicKeyAlgorithm: "EC P-256",
...
export const certificatePage = page<CertificateItem>([
	{
		...
		subjectDn: "CN=sensor-floor-01",
		sanUri: "urn:certgate:device:sensor-floor-01",
		issuerDn: "CN=CertGate Intermediate CA",
		fingerprintSha256: "a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f9",
	...
	},
	{
		...
		subjectDn: "CN=sensor-floor-02",
		sanUri: "urn:certgate:device:sensor-floor-02",
		issuerDn: "CN=CertGate Intermediate CA",
		fingerprintSha256: "b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a",
	...
	},
	{
		...
		sanUri: "urn:certgate:device:sensor-floor-01",
		issuerDn: "CN=CertGate Intermediate CA",
		fingerprintSha256: "c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b",
	...
	},
	{
		...
		sanUri: "urn:certgate:device:sensor-floor-02",
		issuerDn: "CN=CertGate Intermediate CA",
		fingerprintSha256: "d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c",
