...
const MAX_SIZE = 100;
/**
 * 서버 Controller는 page를 Java int로 받는다. 그보다 큰 값을 보내면 Controller의
 * clamp에 닿기도 전에 Spring의 int 변환이 실패해 400이 된다.
 */
...
export function usePageParams() {
	...
	const page = intInRange(searchParams.get("page"), 0, MAX_PAGE, 0);
